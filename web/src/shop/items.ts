...
export const SHOP_ITEMS: ShopItem[] = [
  ...
  { id: "token-dragon",  kind: "token", name: { en: "Dragon",     ru: "Дракон" },        price: 800,  icon: "🐉" },
  { id: "token-unicorn", kind: "token", name: { en: "Unicorn",    ru: "Единорог" },      price: 800,  icon: "🦄" },
  ...
  { id: "token-wizard",  kind: "token", name: { en: "Wizard",     ru: "Маг" },           price: 1100, icon: "🧙" },
  { id: "token-mermaid", kind: "token", name: { en: "Mermaid",    ru: "Русалка" },       price: 1100, icon: "🧜" },
  ...
  { id: "token-gem",     kind: "token", name: { en: "Diamond",    ru: "Бриллиант" },     price: 2000, icon: "💎" },
  ...
  { id: "theme-cosmos",  kind: "theme", name: { en: "Cosmos",       ru: "Космос" },        price: 1500, icon: "🌌" },
  { id: "theme-vapor",   kind: "theme", name: { en: "Vaporwave",    ru: "Вапорвэйв" },     price: 1800, icon: "🌴" },
